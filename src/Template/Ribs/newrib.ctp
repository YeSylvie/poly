...
<div class="row card-inscription">
    <div class="col-sm-12">
        <div class="nav-retour">
            ...
            <h2 class="title-co">Infos bancaires</h2>
        </div>
        <div class="stepper">
        ...
        <div>
            <div class="row row-inscription">
                <div class="col-12">
                    <?= $this->Form->control('holder', ['label' => false, 'placeholder' => 'Titulaire', 'class' => 'input-co']); ?>
                </div>
            </div>
            <div class="row row-inscription">
                <div class="col-12">
                    <?= $this->Form->control('bic', ['label' => false, 'placeholder' => 'BIC', 'class' => 'input-co']); ?>
                </div>
            </div>
            <div class="row row-inscription">
                <div class="col-12">
                    <?= $this->Form->control('iban', ['label' => false, 'placeholder' => 'IBAN', 'class' => 'input-co']); ?>
                </div>
            </div>
